...
const loadPayPalScript = async (
  ...
  try {
    const paypal = await loadScript({
      "client-id":
        "Ad2JkW_OgGf5EghJ1a0rJ-rg6qpbzHvag4W643joZdOCdGRBBrMnqm7X5pM9Lk2TcOmzG6DE7lggZgFa",
    }); // this is ok to expose
...
const UserOrderDetailsPage = () => {
  ...
  const userInfo = useSelector(
    (state: ReduxAppState) =>
      state.userRegisterLogin.userInfo as StoredUserInfo,
  );
