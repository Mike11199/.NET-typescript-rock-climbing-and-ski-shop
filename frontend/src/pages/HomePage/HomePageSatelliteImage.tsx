...
const NASALogoImage = "https://assets.alpine-peak-climbing-ski-gear.com/site/nasa.png";
const NASALandSatImage = "https://assets.alpine-peak-climbing-ski-gear.com/site/landsat.png";
