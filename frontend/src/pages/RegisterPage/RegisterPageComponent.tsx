...
const RockClimbingPhoto = "https://assets.alpine-peak-climbing-ski-gear.com/site/climbing-inverted-2.png";
const RappelClimbingPhoto = "https://assets.alpine-peak-climbing-ski-gear.com/site/rappel-5.png";
